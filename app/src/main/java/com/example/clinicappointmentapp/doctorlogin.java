            ...
            public void onClick(View view) {
                ...
                try {
                    ...
                    if (password.length()> 0 && email.length()> 0){
                        loadingBar.show();
                        auth.signInWithEmailAndPassword(email,password).addOnCompleteListener(doctorlogin.this, new OnCompleteListener<AuthResult>() {
                            @Override
                            public void onComplete(@NonNull Task<AuthResult> task) {
                                if (!task.isSuccessful()){
                                    ...
                                    Toast.makeText(doctorlogin.this,"You logged in successfully",Toast.LENGTH_LONG).show();
                                    loadingBar.dismiss();


                                    Intent intent = new Intent(doctorlogin.this, Doctor_ShowAppointmentActivity.class);
...
//                                    Prevalent.currentOnLineUsers = users;
                        ...
                        Toast.makeText(doctorlogin.this,"Account with this "+ email+" email do not exists",Toast.LENGTH_LONG).show();
                    }
