...
*/
  ...
  //  }
    ...
    private void setDefaultColor(int i) {
        ...
        switch (i) {
            case 1: c1.setCardBackgroundColor(getResources().getColor(R.color.darkGreen));
                c1.setEnabled(true);
                break;
            case 2:
                c2.setCardBackgroundColor(getResources().getColor(R.color.darkGreen));
                c2.setEnabled(true);
                break;
            case 3:
                c3.setCardBackgroundColor(getResources().getColor(R.color.darkGreen));
                c3.setEnabled(true);
                break;
            case 4:
                c4.setCardBackgroundColor(getResources().getColor(R.color.darkGreen));
                c4.setEnabled(true);
                break;
            case 5:
                c5.setCardBackgroundColor(getResources().getColor(R.color.darkGreen));
                c5.setEnabled(true);
                break;
            case 6:
                c6.setCardBackgroundColor(getResources().getColor(R.color.darkGreen));
                c6.setEnabled(true);
                break;
            case 7:
                c7.setCardBackgroundColor(getResources().getColor(R.color.darkGreen));
                c7.setEnabled(true);
                break;
            case 8:
                c8.setCardBackgroundColor(getResources().getColor(R.color.darkGreen));
                c8.setEnabled(true);
                break;
            case 9:
                c9.setCardBackgroundColor(getResources().getColor(R.color.darkGreen));
                c9.setEnabled(true);
                break;
            case 10:
                c10.setCardBackgroundColor(getResources().getColor(R.color.darkGreen));
                c10.setEnabled(true);
                break;
            case 11:
                c11.setCardBackgroundColor(getResources().getColor(R.color.darkGreen));
                c11.setEnabled(true);
                break;
            case 12:
                c12.setCardBackgroundColor(getResources().getColor(R.color.darkGreen));
                c12.setEnabled(true);
                break;
            case 13:
                c13.setCardBackgroundColor(getResources().getColor(R.color.darkGreen));
                c13.setEnabled(true);
                break;
            case 14:
                c14.setCardBackgroundColor(getResources().getColor(R.color.darkGreen));
                c14.setEnabled(true);
                break;
            case 15:
                c15.setCardBackgroundColor(getResources().getColor(R.color.darkGreen));
                c15.setEnabled(true);
                break;
            case 16:
                c16.setCardBackgroundColor(getResources().getColor(R.color.darkGreen));
                c16.setEnabled(true);
                break;
            case 17:
                c17.setCardBackgroundColor(getResources().getColor(R.color.darkGreen));
                c17.setEnabled(true);
                break;
            case 18:
                c18.setCardBackgroundColor(getResources().getColor(R.color.darkGreen));
                c18.setEnabled(true);
                break;
            case 19:
                c19.setCardBackgroundColor(getResources().getColor(R.color.darkGreen));
                c19.setEnabled(true);
                break;
            case 20:
            ...
            case 21:
                ...
                break;
            case 22:
                c22.setCardBackgroundColor(getResources().getColor(R.color.darkGreen));
                c22.setEnabled(true);
                break;
            case 23:
                c23.setCardBackgroundColor(getResources().getColor(R.color.darkGreen));
                c23.setEnabled(true);
                break;
            case 24:
                c24.setCardBackgroundColor(getResources().getColor(R.color.darkGreen));
                c24.setEnabled(true);
                break;
            case 25:
                c25.setCardBackgroundColor(getResources().getColor(R.color.darkGreen));
                c25.setEnabled(true);
                break;
            case 26:
                c26.setCardBackgroundColor(getResources().getColor(R.color.darkGreen));
                c26.setEnabled(true);
                break;
            case 27:
                c27.setCardBackgroundColor(getResources().getColor(R.color.darkGreen));
                c27.setEnabled(true);
                break;
            case 28:
                c28.setCardBackgroundColor(getResources().getColor(R.color.darkGreen));
                c28.setEnabled(true);
                break;
            case 29:
                c29.setCardBackgroundColor(getResources().getColor(R.color.darkGreen));
                c29.setEnabled(true);
                break;
            case 30:
